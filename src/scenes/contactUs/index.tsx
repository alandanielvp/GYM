        ...
        <div className='mt-10 justify-between gap-8 md:flex'>
            ...
            className='mt-10 basis-3/5 md:mt-0'
                    ...
                    >
                        ...
                        target="_blank"
                        onSubmit={onSubmit}
                        action='https://formsubmit.co/alanvp97@hotmail.com'
                        method="POST"
                        >
                            <input 
                            ...
                            {errors.name && (
                                <p className='mt-1 text-primary-500'>
                                    ...
                                    {errors.name.type === "maxLength" && "Please provide a shorter answer"}
                                    </p>
                            )}
...
<textarea 
                            ...
                            {errors.message && (
                                <p className='mt-1 text-primary-500'>
                                    ...
                                    {errors.message.type === "maxLength" && "Please provide a shorter message"}
                                    </p>
                            )}
